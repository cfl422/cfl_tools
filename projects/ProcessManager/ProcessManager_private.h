...
#ifndef PROCESSMANAGER_PRIVATE_H
#define PROCESSMANAGER_PRIVATE_H
...
#define ORIGINAL_FILENAME	"libProcessManager.dll"
#define PRODUCT_NAME	"ProcessManager"
#define PRODUCT_VERSION	"0.1.1.1"

#endif /*PROCESSMANAGER_PRIVATE_H*/
